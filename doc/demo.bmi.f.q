...
print(mean(spol))       # opisne spremenljivke nimajo povpreèja
...
#
#
boxplot(split(teza,as.numeric(spol)*1000+starost),col="lightgreen",boxwex=.5,main="Teža")
win.graph()
boxplot(split(teza,as.numeric(spol)*1000+starost),col="pink",boxwex=.5,main="Višina")
#
